  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: DraggableScrollableSheet(
        minChildSize: 0,
        initialChildSize: size.height > 441 ? 441/size.height : 1,
        maxChildSize: 1,
        builder: (context, controller){
          return  SingleChildScrollView(
            controller: controller,
            child: Container(
              height: size.height > 411 ? size.height : 411,
              width: size.width,
              ...
              child: Column(
                ...
                children: [
                  ...
                  size.height > 550 ? const SizedBox(height:20) : const SizedBox(height: 0),
